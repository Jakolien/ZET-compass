...
Logger.warning("Reading data from excel file...")
...
Logger.warning("Emptying database tables...")
...
for scenario_name in valid_scenario_names:
    try:
        ...
        Logger.error("Error processing scenario: " + scenario_name)

# Close the database connection
Logger.warning("Saving data and closing database connection...")
